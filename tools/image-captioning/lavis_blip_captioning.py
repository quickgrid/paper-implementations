...
def main() -> None:
    ...
    parser.add_argument('--max_len', metavar='--max-len', help="image size for processing", default=72, type=int)
    parser.add_argument('--min_len', metavar='--min-len', help="image size for processing", default=36, type=int)
